...
if ((typeof ShopifyAPI) === 'undefined') { var ShopifyAPI = {}; }
    ...
    $.each(cart.items, function(index, cartItem) {
      ...
      */
      ...
      item = {
        ...
        originalPrice: Shopify.formatMoney((cartItem.price - (cartItem.total_discount/cartItem.quantity)), settings.moneyFormat),
